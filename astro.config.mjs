...
sidebar: [
  {
    ...
    items: [
      ...
      { slug: 'getting-started/core-pages-and-menus', label: 'الصفحات الأساسية والقوائم' },
      ...
      { slug: 'getting-started/storage-files-and-file-manager', label: ' التخزين والملفات ومدير الملفات' },
  ],
  },
],
      components: {
